...
const double mu = 0.05;   // Long-term mean
...
// Function to simulate Hull-White short rate paths
vector<double> simulateHullWhite(double dt, int seed = 42) {
...
int main() {
    ...
    vector<double> rates = simulateHullWhite(dt);

    // Print simulated interest rate path
    cout << "Hull-White Short Rate Path:\n";
